...
public partial class theDeadlinesContext : DbContext
{
    private readonly IConfiguration _configuration;

    public theDeadlinesContext(IConfiguration configuration)
    {
        _configuration = configuration;
    }

    public theDeadlinesContext(DbContextOptions<theDeadlinesContext> options, IConfiguration configuration)
        : base(options)
    {
        _configuration = configuration;
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            var connectionString = _configuration.GetConnectionString("theDeadlinesContext");
